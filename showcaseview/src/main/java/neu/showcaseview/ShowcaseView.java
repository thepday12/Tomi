...
import neu.showcaseview.targets.Target;
...
public class ShowcaseView extends RelativeLayout
    ...
    protected ShowcaseView(Context context, AttributeSet attrs, int defStyle, boolean newStyle) {
        ...
        if (newStyle) {
            ...
            showcaseDrawer = new StandardShowcaseDrawer(getResources(), context.getTheme(),1);
        }
    ...
    public void hide() {
        // If the type is set to one-shot, store that it has shot
            shotStateStore.storeShot(mIsOneShot);
    ...
    public static class Builder {
         ...
         * @deprecated use {@link #withHoloShowcase(float factor)}, {@link #withNewStyleShowcase()}, or
        ...
        /**
         * Create the {@link neu.showcaseview.ShowcaseView} and show it.
         *
         ...
         * @param factor factor of radius
         */

        public Builder withHoloShowcase(float factor) {
            return setShowcaseDrawer(new StandardShowcaseDrawer(activity.getResources(), activity.getTheme(),factor));
        }
         ...
         *
         * @param target a {@link neu.showcaseview.targets.Target} representing
        ...
        /**
         * Show one shot or any time
         * @param isOneShot <b>true</b> if show one shot<br/>
         *                  <b>false</b> can show any time when build showcase
         *
         */
        public Builder setShowOneShot(Boolean isOneShot){
            showcaseView.mIsOneShot=isOneShot;
            return this;
        }
        /**
        ...
        /**
         * Text to display of button ok
         * @param buttonText
         * @return
         */
        public Builder setButtonLabel(String buttonText) {
            showcaseView.mEndButton.setText(buttonText);
            return this;
        }
         ...
         * @param isBlock <b>True</b> if block any touch <br/>
         *                <b>default - false</b>
         * @return
         */
        public Builder blockAllTouches(boolean isBlock) {
            showcaseView.setBlockAllTouches(isBlock);
            return this;
        }
    ...
    /**
     * new.showcaseview.ShowcaseView.Builder#setSingleShot(long)
     */
     ...
     *
     * @param layoutParams a {@link LayoutParams} representing
    ...
    /**
     * new.showcaseview.ShowcaseView.Builder#hideOnTouchOutside()
     */
    @Override
    ...
    /**
     * new.showcaseview.ShowcaseView.Builder#doNotBlockTouches()
     */
    @Override
    ...
    /**
     * new.showcaseview.ShowcaseView.Builder#setStyle(int)
     */
    @Override
